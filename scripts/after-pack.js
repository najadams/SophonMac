  ...
  if (bsqlSourcePath && fs.existsSync(bsqlSourcePath)) {
    ...
    if (fs.existsSync(buildSourcePath)) {
      ...
      if (releaseSourcePath) {
        ...
        // Note: We avoid copying into lib/binding with hardcoded ABI/platform.
        // The runtime resolves the native addon from build/Release which is sufficient across platforms.
      } else {
